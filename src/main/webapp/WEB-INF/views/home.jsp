...
<div class="container">
	...
	<!-- 
	views폴더 하위에 있는 해당 이미지는 출력되지 않는다. views폴더는
	View파일 즉, jsp만 위치할 수 있다.
	-->
	...
	<h3>Environment 객체를 이용한 외부 파일 참조하기</h3>
	<li>
		<a href="environment/main1" target="_blank">
			외부 파일 참조하기 1(environment객체 사용)
		</a>
	</li>
	...
	<!-- resource폴더에는 html파일을 생성한 후 직접 실행할 수 있다.  -->
	<li>
	...
	resources폴더 하위에서만 사용할 수 있다. 
	 -->
	<li>
		<a href="./notFound.html" target="_blank" >html파일 사용 X</a>
		&nbsp;&nbsp;&nbsp;
		<a href="./resources/found.html" target="_blank" >html파일 사용 O</a>
		&nbsp;&nbsp;&nbsp;
		<a href="./static/found.html" target="_blank" >별칭 사용 가능</a>
	</li>
	
	<!-- 
	webapp하위에서는 JSP파일은 사용할 수 있다. jsp이므로 스크립틀릿이나
	클래스 임포트 등도 모두 가능하다.
	 -->
	<li>
